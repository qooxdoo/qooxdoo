...
def usage():
    ...
    print "  -w           Write HTML output to a file \"pythondoc-<infile>.html\"."
    print "  -V           Increase debug level (repeat for even more output)"
    print
    ...
    print "  -Dstyle=http://myhost.com/my.css  Use style sheet."
    print
...
if __name__ == "__main__":
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], "D:fO:p:Vsxw")
    except getopt.error:
        usage()
    ...
    for filename in args:
        ...
        for file in files:
            ...
            if output_xml:
                ...
                # write to stdout
                out = output_handler.save(module, sys.stdout)
