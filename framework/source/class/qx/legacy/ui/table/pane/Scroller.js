...
qx.Class.define("qx.legacy.ui.table.pane.Scroller",
{
  ...
  */
  ...
  construct : function(table)
  {
    ...
    // init scrollbars
    this._verScrollBar = new qx.legacy.ui.basic.ScrollBar(false);
    this._horScrollBar = new qx.legacy.ui.basic.ScrollBar(true);
    ...
    this._headerClipper = new qx.legacy.ui.layout.CanvasLayout;
    this._headerClipper.setDimension("1*", "auto");
    this._headerClipper.setOverflow("hidden");
    this._headerClipper.add(this._header);

    this._spacer = new qx.legacy.ui.basic.Terminator;
    this._spacer.setWidth(scrollBarWidth);

    this._top = new qx.legacy.ui.layout.HorizontalBoxLayout;
    ...
    var scrollerBody = new qx.legacy.ui.layout.HorizontalBoxLayout;
    ...
    this._focusIndicator.addListener("mouseup", this._onMouseupFocusIndicator, this);
  ...
  */
  ...
  statics :
  {
     ...
     */
    CURSOR_RESIZE_HORIZONTAL : (qx.legacy.core.Client.getInstance().isGecko() && (qx.legacy.core.Client.getInstance().getMajor() > 1 || qx.legacy.core.Client.getInstance().getMinor() >= 8)) ? "ew-resize" : "e-resize"
  },
  ...
  */
  ...
  members :
  {
    ...
    {
      this.fireDataEvent("changeScrollX", evt.getData(), evt.getOldData());
    ...
    _onMouseupFocusIndicator : function(e)
    {
      if (
        ...
        {
          this.dispatchEvent(new qx.legacy.ui.table.pane.CellEvent(this, "cellClick", e), true);
        }
      }
    ...
    _onclickPane : function(evt)
    {
      ...
      if (row != null && col != null)
      {
        ...
        if (
          ...
          if (this.hasListener("cellClick")) {
            this.dispatchEvent(new qx.legacy.ui.table.pane.CellEvent(this, "cellClick", evt), true);
          }
        }
      }
    },
    ...
    _onContextMenu : function(evt)
    {
      ...
      if (
        ...
        {
          this.dispatchEvent(new qx.legacy.ui.table.pane.CellEvent(this, "cellContextmenu", evt), true);
        }
      }
    },
    ...
    _ondblclickPane : function(evt)
    {
      ...
      if (this.hasListener("cellDblclick"))
      {
        ...
        if (row != -1 && row != null)
        {
          this.dispatchEvent(new qx.legacy.ui.table.pane.CellEvent(this, "cellDblclick", evt), true);
        }
      }
    },
    ...
    _showResizeLine : function(x)
    {
      ...
      if (resizeLine == null)
      {
        resizeLine = new qx.legacy.ui.basic.Terminator;
    ...
    startEditing : function()
    {
          ...
          tableModel.isColumnEditable(col))
      {
        ...
        else if (this._cellEditor instanceof qx.legacy.ui.window.Window)
        {
