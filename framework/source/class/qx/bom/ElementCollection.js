  ...
  qx.List.define("qx.bom.ElementCollection",
  {
    members :
    {
      ...
      */       
      ...
      append : function() 
      {
        return this.__domManip(arguments, true, function(elem) {
          if (this.nodeType == 1)
      ...
      before : function() 
      {
        return this.__domManip(arguments, false, function(elem) {
       ...
       * TODO
       */
      __domManip: function(args, table, callback) 
      {
        if (this[0]) 
        {
          ...
          var extra = this.length > 1 ? fragment.cloneNode(true) : fragment;
