...
qx.Class.define("qx.test.event.Messaging",
{
  ...
  members : {
    ...
    testTwoChannels : function() {
      ...
      this.__m.execute("GET", "/get", null, data);
      ...
      this.__m.execute("POST", "/post", null, data);
    ...
    testGet : function() {
      ...
      this.__m.execute("get", "/", null, data);
    ...
    testRegExp : function() {
      ...
      this.__m.execute("xyz", "xyzabc", null, data);
      this.__m.execute("xyz", "abcxyz", null, data);
      this.assertCalledOnce(handler);
      this.assertCalledOn(handler, ctx);
    ...
    testGetAll : function() {
      ...
      this.__m.execute("a", "xyzabc");
      this.__m.execute("a", "abcxyz");
    ...
    testParam : function() {
      ...
      this.__m.execute("POST", "/123456/affe", data);
      this.assertCalledOnce(handler);
      this.assertCalledOn(handler, ctx);
    ...
    testMultipleParam : function() {
      ...
      this.__m.execute("POST", "/123456-xyz/affe", data);
      this.assertCalledOnce(handler);
      this.assertCalledWith(handler, 
