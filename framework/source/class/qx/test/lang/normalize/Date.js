...
qx.Class.define("qx.test.lang.normalize.Date",
{
  ...
  members :
  {
    testParse: function()
    {
      ...
      this.assertIdentical(Date.parse('2001-02-03T04:05'), Date.UTC(2001, 1, 3, 4, 5, 0, 0), '2001-02-03T04:05');
      this.assertIdentical(Date.parse('2001-02-03T04:05:06'), Date.UTC(2001, 1, 3, 4, 5, 6, 0), '2001-02-03T04:05:06');
      this.assertIdentical(Date.parse('2001-02-03T04:05:06.007'), Date.UTC(2001, 1, 3, 4, 5, 6, 7), '2001-02-03T04:05:06.007');
      ...
      this.assertIdentical(Date.parse('2001T04:05:06.007'), Date.UTC(2001, 0, 1, 4, 5, 6, 7), '2001T04:05:06.007');
      this.assertIdentical(Date.parse('2001-02T04:05:06.007'), Date.UTC(2001, 1, 1, 4, 5, 6, 7), '2001-02T04:05:06.007');
      this.assertIdentical(Date.parse('2001-02-03T04:05:06.007'), Date.UTC(2001, 1, 3, 4, 5, 6, 7), '2001-02-03T04:05:06.007');
      this.assertIdentical(Date.parse('2001-02-03T04:05:06.007-06:30'), Date.UTC(2001, 1, 3, 4, 5, 6, 7) + sixHoursThirty, '2001-02-03T04:05:06.007-06:30');

      this.assertIdentical(Date.parse('-010000T04:05'), Date.UTC(-10000, 0, 1, 4, 5, 0, 0), '-010000T04:05');
      this.assertIdentical(Date.parse('-010000-02T04:05'), Date.UTC(-10000, 1, 1, 4, 5, 0, 0), '-010000-02T04:05');
      this.assertIdentical(Date.parse('-010000-02-03T04:05'), Date.UTC(-10000, 1, 3, 4, 5, 0, 0), '-010000-02-03T04:05');
