  ...
  */
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      l0.setMarginTop(5);
      l0.setAlignY('middle');
      container.add(l0, {row: 0, column: 0});
      ...
      container.add(infoContainer, {row:0, column: 2});
      ...
      var part1Label = new qx.ui.basic.Label("<u>Static translation [found in .po files]. Hover the labels below to see more info.</u>");
      part1Label.setRich(true);
      part1Label.setMarginTop(15);
      container.add(part1Label, {row: 1,column: 0, colSpan: 4});
      
      // Simple Translate
      var translation1 = new qx.ui.basic.Label();
      translation1.setAlignY('bottom');
      container.add(translation1, {row: 2,column: 0,rowSpan: 2});
      ...
      container.add(numberOfApples, {row: 2, column: 1});
      var translation2 = new qx.ui.basic.Label();
      translation2.setAlignY('bottom');
      container.add(translation2, {row: 3, column: 1});
      ...
      translation3.setAlignY('bottom');
      container.add(translation3, {row: 2, column: 2, rowSpan: 2});
      ...
      var translation4 = new qx.ui.basic.Label();
      translation4.setAlignY('bottom');
      container.add(translation4, {row: 2, column: 3, rowSpan: 2});
      
      var part2Label = new qx.ui.basic.Label("<u>Dynamic translation. This is added at runtime.</u>");
      part2Label.setRich(true);
      part2Label.setMarginTop(15);
      container.add(part2Label, {row: 4,column: 0, colSpan: 3});
