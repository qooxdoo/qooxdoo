 ...
 * @deprecated
 */
qx.Class.define("qx.legacy.io.local.CookieApi",
{
  /*
  *****************************************************************************
     STATICS
  ...
  statics :
  {
    ...
    */
    ...
    set : function(vName, vValue, vExpires, vPath, vDomain, vSecure)
    {
      ...
      {
        vCookie.push(";");
        vCookie.push(qx.legacy.io.local.CookieApi.STR_EXPIRES);
        vCookie.push("=");
      ...
      {
        vCookie.push(";");
        vCookie.push(qx.legacy.io.local.CookieApi.STR_PATH);
        vCookie.push("=");
        vCookie.push(vPath);
      }
      ...
      {
        vCookie.push(";");
        vCookie.push(qx.legacy.io.local.CookieApi.STR_DOMAIN);
        vCookie.push("=");
      ...
      {
        vCookie.push(";");
        vCookie.push(qx.legacy.io.local.CookieApi.STR_SECURE);
      }
    ...
    {
      if (!qx.legacy.io.local.CookieApi.get(vName)) {
        return;
      }
      ...
      vCookie.push(qx.legacy.io.local.CookieApi.STR_EXPIRES);
      vCookie.push("=");
      vCookie.push(qx.legacy.io.local.CookieApi.STR_DELDATA);
