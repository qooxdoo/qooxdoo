    ...
    */
    ...
    _getAllAfter : function(parent, widget, arr)
    {
      ...
      for (var i=0; i<len; i++)
      {
        ...
        if (!(child instanceof qx.legacy.ui.core.Parent) && !(child instanceof qx.legacy.ui.basic.Terminator)) {
          continue;
        }
        ...
        if (!child.isFocusRoot() && child instanceof qx.legacy.ui.core.Parent) {
