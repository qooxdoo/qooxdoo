  ...
  construct : function(caption, icon, mainWindow)
  {
    ...
    if (window.location.protocol == "http:") {
      ...
      defaultButton.addListener("execute", function() {
        ...
        userExt.setValue(qx.core.Setting.get("inspector.selenium.extensions"));
      }, this);
    ...
    var noticeText = 'See the <a href="http://manual.qooxdoo.org/1.3.1/pages/application/inspector_selenium.html" target="_blank">manual page</a> for an explanation of these settings.';
