 ...
 */
qx.Class.define("bomdemo.box.Draggable",
{
  extend : qx.core.Object,

  /**
   * @param box {bomdemo.box.Box} box instance to decorate
   */
  ...
  members :
  {
     ...
     *
     * @type member
     * @return {bomdemo.box.Box} box instance
     */
    getBox : function() {
      return this.__box;
    },
    ...
    __addListener : function()
    {
      ...
      qx.bom.Element.addListener(this.__handle, "dragend", bomdemo.dragdrop.Manager.getInstance().stopSession, bomdemo.dragdrop.Manager.getInstance());
      
      qx.bom.Element.addListener(this.__handle, "drag", function(e){
      ...
      }, bomdemo.dragdrop.Manager.getInstance());
    },
    ...
    _onDragStart : function(e)
    {
      if (e.isLeftPressed())
      {
        ...
        bomdemo.box.Manager.getInstance().setActiveBox(this.__box);
        
        // let the dragDrop manager take control
        bomdemo.dragdrop.Manager.getInstance().startSession(this.__box);
      }
    }
  },
