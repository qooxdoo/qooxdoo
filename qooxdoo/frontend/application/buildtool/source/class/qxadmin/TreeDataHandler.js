...
qx.Class.define("qxadmin.TreeDataHandler",
{
  ...
  */
  ...
  members :
  {
      ...
      function insert(root, el)
      {
        ...
        function createPath(parent, path)
        {
          ...
          else
          {
            ...
            if (nextRoot == null)
            {
              nextRoot = new qxadmin.Tree(head);
              parent.add(nextRoot);
            }
    ...
    {
      // current node
      var tree = arguments[1] || new qxadmin.Tree(struct.classname);
      var node;
      ...
      {
        node = new qxadmin.Tree(struct.tests[j].name);
     ...
     * @return {var} fullName {String} like "qxadmin.test.Class.testEmptyClass"
     */
