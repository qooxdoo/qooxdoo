...
def addCommandLineOptions(parser):
    group = optparse.OptionGroup(parser, "Pretty-print Options")
    group.add_option("--pretty-print-indent-string", metavar="STRING", dest="prettypIndentString", default="  ", help="String used for indenting source code; escapes possible, e.g. \"\\t\" (default: \"  \")")
    group.add_option("--pretty-print-newline-before-open-curly", dest="prettypOpenCurlyNewlineBefore",
