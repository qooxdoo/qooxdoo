...
COMPUTED_CLASS_PATH = --class-path $(FRAMEWORK_SOURCE_PATH)/class,$(APPLICATION_SOURCE_PATH)/class --class-path "$(APPLICATION_ADDITIONAL_CLASS_PATH)"
COMPUTED_CLASS_URI = --class-uri $(FRAMEWORK_SOURCE_URI)/class,$(APPLICATION_HTML_TO_ROOT_URI)/class --class-uri "$(APPLICATION_ADDITIONAL_CLASS_URI)"
