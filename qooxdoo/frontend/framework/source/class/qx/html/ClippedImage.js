/**
 * A ClippeImage wraps a DOM element, which displays a clipped image. All images
 * shown with this class must be registered using
...
qx.Class.define("qx.html.ClippedImage",
{
  ...
  */
  ...
  statics :
  {
     ...
     *
     * @static
     * @signature function(source, xOffset, yOffset, width, height)
