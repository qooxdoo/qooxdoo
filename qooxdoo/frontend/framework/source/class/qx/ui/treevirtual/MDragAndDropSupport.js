 ...
 * 
 * To drag & drop within the same TreeVirtual, you need to patch the 
 * qx.event.handler.DragAndDropHandler class like so (if it hasn't already been patched in SVN)
 * Line 262:  replace
