...
/**
 * This class serves for resizing components like Windows.  It is designed for multiple inheritance,
 * because a Window needs to inherit from Popup and Resizer from CanvasLayout.
 */
qx.OO.defineClass('qx.ui.window.BaseResizer', Object, function() {
});

/*
 * This simulates multiple inheritance, and the construction phase.
 */
qx.Class._inheritFrom = function(object) {
  qx.lang.Object.carefullyMergeWith(object, qx.ui.window.BaseResizer.prototype);
  object._frame = new qx.ui.basic.Terminator;
  object._frame.setAppearance("window-resize-frame");
}
...
/**
 * This method is called after the user has selected the new width
 */
...
/**
 * This method is called after the user has selected the new height
 */
...
/**
 * This method defines the parent widget used for limiting the size of this resizer.
 */
...
/**
 * Determines widget used for getting the minimum size.
 */
qx.Proto._getMinSizeReference = function() {
  throw new Error('This method is abstract');
}

qx.Proto._disposeResizer = function()
{
  if (this._frame)
  {
    this._frame.dispose();
