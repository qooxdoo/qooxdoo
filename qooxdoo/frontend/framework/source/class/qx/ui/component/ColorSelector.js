  ...
  members :
  {
    ...
    */
    ...
    _onBrightnessHandleMouseDown : function(e)
    {
      ...
      this._brightnessSubtract = qx.legacy.html.Location.getPageOuterTop(this._brightnessField.getElement()) + (e.getPageY() - qx.legacy.html.Location.getPageBoxTop(this._brightnessHandle.getElement()));
    ...
    _onBrightnessFieldMouseDown : function(e)
    {
      ...
      this._brightnessSubtract = qx.legacy.html.Location.getPageOuterTop(this._brightnessField.getElement()) + Math.round(qx.legacy.html.Dimension.getBoxHeight(this._brightnessHandle.getElement()) / 2);
    ...
    */
    ...
    _onHueSaturationHandleMouseDown : function(e)
    {
      ...
      this._hueSaturationSubtractTop = qx.legacy.html.Location.getPageOuterTop(this._hueSaturationField.getElement()) + (e.getPageY() - qx.legacy.html.Location.getPageBoxTop(this._hueSaturationHandle.getElement()));
      this._hueSaturationSubtractLeft = qx.legacy.html.Location.getPageOuterLeft(this._hueSaturationField.getElement()) + (e.getPageX() - qx.legacy.html.Location.getPageBoxLeft(this._hueSaturationHandle.getElement()));
    ...
    _onHueSaturationFieldMouseDown : function(e)
    {
      ...
      this._hueSaturationSubtractTop = qx.legacy.html.Location.getPageOuterTop(this._hueSaturationField.getElement()) + Math.round(qx.legacy.html.Dimension.getBoxHeight(this._hueSaturationHandle.getElement()) / 2);
      this._hueSaturationSubtractLeft = qx.legacy.html.Location.getPageOuterLeft(this._hueSaturationField.getElement()) + Math.round(qx.legacy.html.Dimension.getBoxWidth(this._hueSaturationHandle.getElement()) / 2);
