...
qx.Clazz.define("qx.renderer.color.Color",
{
  ...
  */
  ...
  statics :
  {
    ...
    */
    ...
    r_hex3 : /^#([0-9a-f]{1})([0-9a-f]{1})([0-9a-f]{1})$/,
    r_hex6 : /^#([0-9a-f]{1})([0-9a-f]{1})([0-9a-f]{1})([0-9a-f]{1})([0-9a-f]{1})([0-9a-f]{1})$/,
    r_cssrgb : /^rgb\(\s*([0-9]{1,3}\.{0,1}[0-9]*)\s*,\s*([0-9]{1,3}\.{0,1}[0-9]*)\s*,\s*([0-9]{1,3}\.{0,1}[0-9]*)\s*\)$/,

    r_rgb : /^[0-9]{1,3},[0-9]{1,3},[0-9]{1,3}$/,
    r_number : /^[0-9]{1,3}\.{0,1}[0-9]*$/,
    r_percent : /^[0-9]{1,3}\.{0,1}[0-9]*%$/,
  ...
  */
  ...
  members :
  {
    ...
    */
     ...
     *
     * @type member
     * @param vInValue {var} TODOC
     * @return {var} TODOC
     * @throws TODOC
     */
    _normalize : function(vInValue)
    {
