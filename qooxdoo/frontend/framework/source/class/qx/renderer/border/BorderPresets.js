...
qx.Class.define("qx.renderer.border.BorderPresets",
{
  statics :
  {
    ...
    init : function()
    {
      ...
      this.inset = new qx.renderer.border.Border(2, "inset");
      this.outset = new qx.renderer.border.Border(2, "outset");
      this.groove = new qx.renderer.border.Border(2, "groove");
      this.ridge = new qx.renderer.border.Border(2, "ridge");
      this.thinInset = new qx.renderer.border.Border(1, "inset");
      this.thinOutset = new qx.renderer.border.Border(1, "outset");

      this.verticalDivider = new qx.renderer.border.Border(1, "inset");
      this.verticalDivider.setLeftWidth(0);
      this.verticalDivider.setRightWidth(0);

      this.horizontalDivider = new qx.renderer.border.Border(1, "inset");
      this.horizontalDivider.setTopWidth(0);
      this.horizontalDivider.setBottomWidth(0);

      this.shadow = new qx.renderer.border.Border(1, "solid", "threedshadow");
      this.lightShadow = new qx.renderer.border.Border(1, "solid", "threedlightshadow");
      this.info = new qx.renderer.border.Border(1, "solid", "infotext");
    },
