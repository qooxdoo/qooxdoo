...
qx.Class.define("qx.legacy.ui.table2.pane.CellEvent",
{
  ...
  */
  ...
  {
    /**
     * @param scroller    {qx.legacy.ui.table2.pane.Scroller}
     */
    init : function(scroller, evt)
    {
      this.base(arguments, evt.getDomEvent());
