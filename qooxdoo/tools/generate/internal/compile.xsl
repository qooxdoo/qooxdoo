...
<xsl:template match="/">
  <html>
    <head>
      ...
      <script type="text/javascript" src="{$pathrel}main.js"></script>
      <link media="screen" href="{$pathrel}screen.css" type="text/css" rel="stylesheet"/>
      <link media="print" href="{$pathrel}print.css" type="text/css" rel="stylesheet"/>
    </head>
    <body>
      <xsl:choose>
