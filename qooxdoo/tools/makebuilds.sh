...
which zip > /dev/null 2> /dev/null && zip -qr9 ../../archives/qooxdoo-allwithdocs.zip public tools
which tar > /dev/null 2> /dev/null && tar cfj ../../archives/qooxdoo-allwithdocs.tar.bz2 public tools
which tar > /dev/null 2> /dev/null && tar cfz ../../archives/qooxdoo-allwithdocs.tar.gz public tools
which 7za > /dev/null 2> /dev/null && 7za a -bd ../../archives/qooxdoo-allwithdocs.7z public tools 2> /dev/null
cd ../../../

echo "[C-2/4] >>> Building ALL Archives"
cd build/snapshots/all
which zip > /dev/null 2> /dev/null && zip -qr9 ../../archives/qooxdoo-all.zip public tools
which tar > /dev/null 2> /dev/null && tar cfj ../../archives/qooxdoo-all.tar.bz2 public tools
which tar > /dev/null 2> /dev/null && tar cfz ../../archives/qooxdoo-all.tar.gz public tools
which 7za > /dev/null 2> /dev/null && 7za a -bd ../../archives/qooxdoo-all.7z public tools 2> /dev/null
cd ../../../

echo "[C-3/4] >>> Building DEVELOPER Archives"
cd build/snapshots/developer
which zip > /dev/null 2> /dev/null && zip -qr9 ../../archives/qooxdoo-developer.zip public tools
which tar > /dev/null 2> /dev/null && tar cfj ../../archives/qooxdoo-developer.tar.bz2 public tools
which tar > /dev/null 2> /dev/null && tar cfz ../../archives/qooxdoo-developer.tar.gz public tools
which 7za > /dev/null 2> /dev/null && 7za a -bd ../../archives/qooxdoo-developer.7z public tools 2> /dev/null
cd ../../../

echo "[C-4/4] >>> Building USER Archives"
cd build/snapshots/user
which zip > /dev/null 2> /dev/null && zip -qr9 ../../archives/qooxdoo-user.zip public tools
which tar > /dev/null 2> /dev/null && tar cfj ../../archives/qooxdoo-user.tar.bz2 public tools
which tar > /dev/null 2> /dev/null && tar cfz ../../archives/qooxdoo-user.tar.gz public tools
which 7za > /dev/null 2> /dev/null && 7za a -bd ../../archives/qooxdoo-user.7z public tools 2> /dev/null
cd ../../../
