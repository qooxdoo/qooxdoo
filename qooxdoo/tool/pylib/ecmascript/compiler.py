...
def addCommandLineOptions(parser):
    ...
    parser.add_option("--pretty-print-comments-block-addMissing", action="store_true", dest="prettypCommentsBlockAdd", default=True, help="Add JSDoc block comments, e.g. ahead of methods (default: True)")
