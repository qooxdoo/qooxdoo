...
function QxWindow(vCaption, vIcon)
{
  ...
  ct.setCursor(QxConst.CORE_DEFAULT);
  ct.setStyleProperty("fontWeight", "bold");
  ct.setMarginRight(2);
  ...
  sb.setBorder(QxBorderObject.presets.thinInset);
  sb.setWidth(null);
  sb.setBackgroundColor("threedface");
  sb.setColor("windowtext");
  ...
  st.setCursor(QxConst.CORE_DEFAULT);
...
proto._maximize = function()
{
  ...
  // reset border
  this.setBorder(QxBorder.presets.none);
...
QxWindow.CAPTIONBGCOLOR_ACTIVE = new QxColorObject("activecaption");
QxWindow.CAPTIONCOLOR_ACTIVE = new QxColorObject("captiontext");
QxWindow.CAPTIONBGCOLOR_INACTIVE = new QxColorObject("inactivecaption");
QxWindow.CAPTIONCOLOR_INACTIVE = new QxColorObject("inactivecaptiontext");
...
proto._applyStateStyleDesign = function(vStates)
{
  ...
  if (vStates.active)
  {
    cb.setBackgroundColor(QxWindow.CAPTIONBGCOLOR_ACTIVE);
    cb.setColor(QxWindow.CAPTIONCOLOR_ACTIVE);
  }
  else
  {
    cb.setBackgroundColor(QxWindow.CAPTIONBGCOLOR_INACTIVE);
    cb.setColor(QxWindow.CAPTIONCOLOR_INACTIVE);
  };
};
