...
/**
 * @brief
 * qx.ui.treeFullControl.TreeFolderFull objects are tree rows which may contain sub-trees 
 *
 * @param
 * treeRowStructure -
 ...
 *   this tree row.
 */
qx.OO.defineClass("qx.ui.treeFullControl.TreeFolderFull", qx.ui.treeFullControl.AbstractTreeElement, 
...
qx.Proto._createChildrenStructure = function()
{
  ...
  if (!this._horizontalLayout)
  {
    ...
    {
      this._treeRowStructure._fields[i].setParent(this._horizontalLayout);
    }

    // We don't need the tree row structure any more.
    this._treeRowStructure = null;
  };
