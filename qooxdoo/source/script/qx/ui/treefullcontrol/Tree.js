...
#package(tree)
#use(qx.ui.treeFullControl.TreeFull)
 ...
 */
qx.OO.defineClass("qx.ui.treeFullControl.TreeCompat", qx.ui.treeFullControl.TreeFull, 
function(vLabel, vIcon, vIconSelected)
{
  ...
  qx.ui.treeFullControl.TreeFull.call(this, treeRowStructure);
});
