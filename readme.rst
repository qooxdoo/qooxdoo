...
see http://manual.qooxdoo.org/1.6.1/pages/getting_started.html
...
* Release Notes
  http://qooxdoo.org/about/release_notes/1.6.1

* User Manual
  http://manual.qooxdoo.org/1.6.1

* API Documentation
  http://api.qooxdoo.org/1.6.1
