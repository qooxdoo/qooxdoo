...
see http://manual.qooxdoo.org/5.0/pages/getting_started.html .
...
* Release Notes
  http://qooxdoo.org/project/release_notes/5.0

* User Manual
  http://manual.qooxdoo.org/5.0

* API Documentation
  http://api.qooxdoo.org/5.0
