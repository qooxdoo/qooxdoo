...
see http://manual.qooxdoo.org/4.2/pages/getting_started.html .
...
* Release Notes
  http://qooxdoo.org/project/release_notes/4.2

* User Manual
  http://manual.qooxdoo.org/4.2

* API Documentation
  http://api.qooxdoo.org/4.2
