...
see http://manual.qooxdoo.org/4.1.1/pages/getting_started.html .
...
* Release Notes
  http://qooxdoo.org/project/release_notes/4.1.1

* User Manual
  http://manual.qooxdoo.org/4.1.1

* API Documentation
  http://api.qooxdoo.org/4.1.1
