...
qx.Class.define("qxcompiler.ClassFile", {
  ...
  construct: function (analyser, className, library) {
    ...
    this.__sourceFilename = qxcompiler.ClassFile.getSourcePath(library, className);
    ...
    _babelClassPlugin: function() {
      ...
      var VISITOR = {
        ...
        MemberExpression(path) {
          ...
          if (qxcompiler.ClassFile.GLOBAL_SYMBOLS[members[0]] || t.hasDeclaration(members[0]))
            return;
  ...
  statics: {
     ...
     * Returns the absolute path to the class file
     * 
     * @param library {qxcompiler.app.Library}
