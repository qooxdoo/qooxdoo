 ...
 */
qx.Class.define("qxcompiler.targets.TypeScriptWriter", {
  ...
  members: {
     ...
     * 
     * @param application {qxcompiler.app.Application?} the application; if not provided, all classes are output
     */
    ...
    getType: function(t) {
      ...
      if (qxcompiler.targets.TypeScriptWriter.TYPE_MAPPINGS.hasOwnProperty(t)) {
        var result = qxcompiler.targets.TypeScriptWriter.TYPE_MAPPINGS[t];
        return result;
      }
    ...
    writeMethods: function(methods, classMeta, isStatic = false) {
      if (!methods || !Object.keys(methods).length)
        return;
      var IGNORE = qxcompiler.targets.TypeScriptWriter.IGNORE[this.__currentClass.className];
