...
module.exports = qx.Class.define("qxcompiler.targets.BuildTarget", {
  ...
  members: {
            ...
            async.eachSeries(uris,
                function (uri, cb) {
                  ...
                  if (namespace == "__out__")
                    rs = fs.createReadStream(t.getOutputDir() + "/" + application.getName() + "/" + path);
                  else
    ...
    _afterWriteApplication: function(compileInfo, cb) {
      ...
      var bootJs = appRootDir + application.getName() + "/" + t.getScriptPrefix() + "boot.js";
      var uncompressedJs = appRootDir + application.getName() + "/" + t.getScriptPrefix() + "uncompressed.js";
