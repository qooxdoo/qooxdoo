        ...
        p = p
          ...
          .then(() => {
            ...
            return fs.writeFileAsync(partJs, result.code, { encoding: "utf8" })
              ...
              .then(() => {
                fs.writeFileAsync(partSourcemap, result.map, { encoding: "utf8" })
              })
              .then(() => {
