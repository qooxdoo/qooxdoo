...
qx.$$loader = {
  ...
  delayDefer: false,
  feedback: window.QOOXDOO_LOADING_FEEDBACK || null,
  isLoadChunked: false,
  loadChunkSize: null,
...
/*
 * Get settings from feedback
 */
if (qx.$$loader.feedback) {
  // If there's feedback, default to chunked
  qx.$$loader.isLoadChunked = true;
  var settings = qx.$$loader.feedback({ command: "get-settings" })||{};
  ...
  qx.$$loader.isLoadParallel && qx.$$loader.isLoadChunked ?
    function(callback) {
      ...
      function onLoad() {
        ...
        if (qx.$$loader.feedback)
          qx.$$loader.feedback(options, checkForEnd);
        else
          checkForEnd();
      }
    ...
    function(callback) {
      ...
      function loadNext() {
        ...
        loadScript(uri, function() {
          options.numScriptsLoaded++;
          if (qx.$$loader.feedback)
            qx.$$loader.feedback(options, queueLoadNext);
          else
            queueLoadNext();
        });
      }
