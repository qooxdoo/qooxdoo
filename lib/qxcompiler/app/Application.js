...
qx.Class.define("qxcompiler.app.Application", {
  ...
  members: {
    ...
    /**
     * Adds a part alias
     * @param alias {PartAlias} the part alias to add
     */
    addPartAlias: function(alias) {
      if (!this.__partAliases)
        this.__partAliases = [];
      this.__partAliases.push(alias);
    },
    
    /**
     * Returns the part aliases, or null if there are none defined
     * @return {PartAlias[]}
     */
    getPartAliases: function() {
      return this.__partAliases || [];
    },
