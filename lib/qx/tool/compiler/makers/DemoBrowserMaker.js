 ...
 */
module.exports = qx.Class.define("qx.tool.compiler.makers.DemoBrowserMaker", {
            ...
            async.series([
              ...
              function(cb) {
                ...
                DEMO_APP_CLASSES.forEach(function(name) {
                  appInfos.push({
                    app: new qx.tool.compiler.app.Application(name, [
                      "qx.theme.Indigo",
                      "qx.theme.Simple",
                      "qx.theme.Modern",
                      "qx.theme.Classic",
                ...
                appInfos.push({
                  app: new qx.tool.compiler.app.Application("demobrowser.Application", [
                      "demobrowser.Theme",
                      "qx.theme.Indigo",
                      "qx.theme.Simple",
                      "qx.theme.Modern",
              ...
              function(cb) {
                ...
                async.eachSeries(appInfos,
                  function(appInfo, cb) {
                    ...
                    target.generateApplication(app, function(err) {
                      if (err)
                        return cb(err);
                      cb();
                    });
              ...
              function(cb) {
                ...
                async.parallel([
                   ...
                   */
                  function(cb) {
                    qx.tool.compiler.files.Utils.sync(t.__qooxdooPath + "/application/demobrowser/source/demo",
                   ...
                   */
                  function(cb) {
                    qx.tool.compiler.files.Utils.sync(t.__qooxdooPath + "/application/demobrowser/source/resource",
                  ...
                  function(cb) {
                    async.each(DEMO_APP_CLASSES, function(name, cb) {
                      ...
                      qx.tool.compiler.files.Utils.sync(filename, target.getOutputDir() + "/script/" + name + ".src.js")
                        .then(() => cb()).catch((err) => cb(err));
                    }, cb);
                  },
