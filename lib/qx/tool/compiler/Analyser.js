        ...
        async function analyseClassEntities(meta, first) {
          ...
          if (meta.properties) {
            ...
            for (var propertyName in meta.properties) {
              ...
              addPropertyAccessor(propertyMeta, "get" + upname, "get", type, null);
              if (type == "Boolean")
                addPropertyAccessor(propertyMeta, "is" + upname, "is", type, null);
              ...
              if (propertyMeta.async) {
                addPropertyAccessor(propertyMeta, "get" + upname + "Async", "getAsync", "Promise", null);
                if (type == "Boolean")
                  addPropertyAccessor(propertyMeta, "is" + upname + "Async", "isAsync", "Promise", null);
