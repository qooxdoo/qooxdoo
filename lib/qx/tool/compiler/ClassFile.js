    ...
    _babelClassPlugin: function() {
      ...
      var CLASS_DEF_VISITOR = {
        Property(path) {
          ...
          let allowedKeys = ALLOWED_KEYS[t.__definingType];
          if (t.__definingType === "Class")
            allowedKeys = allowedKeys[ t.__classMeta.isStatic ? "static" : "normal" ]; 

          if (allowedKeys[keyName] === undefined)
            t.addMarker("compiler.invalidClassDefinitionEntry", prop.value.loc, t.__definingType, keyName);
