 ...
 * @returns {ConfigFile}
 */
qx.Class.define("qx.tool.compiler.generator.ConfigFile", {
                ...
                if (data.include) {
                  async.forEach(data.include,
                      function(incFile, callback) {
                        ...
                        incFile.configFile = new qx.tool.compiler.generator.ConfigFile(this.__config, incFilePath, incFile.as||null);
