...
qx.Class.define("qx.tool.compiler.targets.TypeScriptWriter", {
  ...
  members: {
     ...
     * 
     * @param application {qx.tool.compiler.app.Application?} the application; if not provided, all classes are output
     */
      ...
      return new Promise((resolve, reject) => {
        ...
        this.writeBase()
          .then(async () => {
            ...
            this.__classes = new qx.tool.compiler.utils.IndexedArray();
            if (application) {
    ...
    getType: function(t) {
      ...
      if (qx.tool.compiler.targets.TypeScriptWriter.TYPE_MAPPINGS.hasOwnProperty(t)) {
