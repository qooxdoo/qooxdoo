...
qx.Class.define("qx.tool.compiler.utils.LogManager", {
  ...
  construct: function() {
    ...
    this._sinks = [];
    this._config = {};
    this._defaultSink = qx.tool.compiler.utils.LogManager.consoleSink;
  ...
  statics: {
    ...
    getInstance: function() {
      if (!this.__instance) {
        this.__instance = new qx.tool.compiler.utils.LogManager();
      }
  ...
  members: {
    loadConfig: async function(config) {
      if (typeof config == "string") {
        config = await qx.tool.compiler.utils.Json.loadJsonAsync(config);
      }
    ...
    getLogger: function(id) {
      var logger = this._loggers[id];
      if (!logger) {
        logger = this._loggers[id] = new qx.tool.compiler.utils.Logger(id, this.getLoggerLevel(id));
      }
      return logger;
    },
...
module.exports = qx.tool.compiler.utils.LogManager;
