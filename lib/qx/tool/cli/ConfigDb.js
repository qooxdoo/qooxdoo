...
qx.Class.define("qx.tool.cli.ConfigDb", {
  ...
  members: {
     ...
     */
    load: async function() {
      this.__db = (await qx.tool.compiler.utils.Json.loadJsonAsync(this.getPath())) || {};
    },
     ...
     */
    save: async function() {
      await await qx.tool.cli.Utils.makeParentDir(this.getPath());
      await qx.tool.compiler.utils.Json.saveJsonAsync(this.getPath(), this.__db);
    },
