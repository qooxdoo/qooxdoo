...
-   [Canvas with pixel positions](http://www.qooxdoo.org/devel/demobrowser/#layout~Canvas_Fixed.html)
-   [Canvas with percent positions and dimensions](http://www.qooxdoo.org/devel/demobrowser/#layout~Canvas_Percent.html)
-   [Canvas showing left and right attachment of children](http://www.qooxdoo.org/devel/demobrowser/#layout~Canvas_LeftRight.html)
-   [Canvas with children having minimum and maximum dimensions](http://www.qooxdoo.org/devel/demobrowser/#layout~Canvas_MinMaxSizes.html)

API
---

Here is a link to the API of the layout manager:
[qx.ui.layout.Canvas](http://www.qooxdoo.org/devel/api/index.html#qx.ui.layout.Canvas)
