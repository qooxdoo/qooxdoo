 ...
 */
qx.Class.define("bomdemo.dragdrop.Manager",
{
  type : "singleton",
  ...
  construct : function()
  {
    ...
    qx.event.Registration.addListener(bomdemo.box.Manager.getInstance(), "loaded", this.__addListener, this);
  },
  ...
  members :
  {
    ...
    {
      var groupBoxes = bomdemo.box.Manager.getInstance().getGroupBoxes();
    ...
    __createGhostElement : function()
    {
      ...
      var dimension = bomdemo.box.Util.getComputedDimension(element);
      ...
      bomdemo.box.Util.bringToFront(this.__ghost);
    },
    ...
    stopSession : function(e)
    {
      ...
      bomdemo.box.Manager.getInstance().updateGroupBoxMembers(activeBox.getGroupBoxId(), this.__currentGroupBox, activeBox);
