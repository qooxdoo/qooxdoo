 ...
 *
 * @param container {bomdemo.box.Box} box instance to decorate
 * @param options {Map} Map to pass optional settings
 */
qx.Class.define("bomdemo.box.Resizable",
{
  ...
  members :
  {
    ...
    __mouseDownListener : function(e)
    {
      ...
      if (e.isLeftPressed())
      {
        ...
        bomdemo.box.Util.bringToFront(this.__element);
      }
    },
    ...
    __mouseUpListener : function(e)
    {
      ...
      if (this.__capturingPhase)
      {
        ...
        bomdemo.box.Util.sendToBack(this.__element);
    ...
    {
      var mouseDiff;
      var boxUtil = bomdemo.box.Util;

      var groupBox = bomdemo.box.Manager.getInstance().getGroupBoxDataOfBox(this.__box.getId());
      var groupBoxDimensions = bomdemo.box.Util.getComputedDimension(groupBox.element);
