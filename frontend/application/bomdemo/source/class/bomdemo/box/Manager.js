 ...
 */
qx.Class.define("bomdemo.box.Manager",
{
  type : "singleton",
  ...
  members :
  {
     ...
     * 
     * @param value {bomdemo.box.Box} new active box
     * @param old {bomdemo.box.Box ? null} old active box or null
     * @return {void}
     */
    ...
    load : function()
    {
      ...
      this._init(window[bomdemo.box.Manager.dataKeyRoot]);
    ...
    _init : function(boxData)
    {
      ...
      var groupBoxes = boxData[bomdemo.box.Manager.dataKeyGroupBoxes];
      var boxes      = boxData[bomdemo.box.Manager.dataKeyBoxes];
      ...
      for (var groupBoxId in groupBoxes)
      {
        ...
        for (var k=0, l=groupBoxBoxes.length; k<l; k++)
        {
          ...
          var newBox = new bomdemo.box.Box(boxData, element, null, groupBoxId);
     ...
     * @param box {bomdemo.box.Box} moved box instance
     * @return {void} 
     */
