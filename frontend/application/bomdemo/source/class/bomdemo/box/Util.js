 ...
 */
qx.Class.define("bomdemo.box.Util",
{
  statics :
  {
    ...
    bringToFront : function(element)
    {
      ...
      qx.bom.element.Style.set(element, "zIndex", zIndex + bomdemo.box.Util.__zIndexOffset);
    },
    ...
    {
      var width  = bomdemo.box.Util.getStyleProperty(element, "width", true);
      var height = bomdemo.box.Util.getStyleProperty(element, "height", true);
