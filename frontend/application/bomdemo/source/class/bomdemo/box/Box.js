 ...
 */
qx.Class.define("bomdemo.box.Box",
{
  ...
  construct : function(boxData, element, styles, groupBoxId)
  {
    ...
    if (boxData.resizable)
    {
      ...
      this.__resizableComponent = new bomdemo.box.Resizable(this, options);
    }
    ...
    if (boxData.draggable)
    {
      ...
      this.__draggableComponent = new bomdemo.box.Draggable(this);
    }
  ...
  members :
  {
     ...
     *
     * @type member
     * @return {bomdemo.box.Draggable} draggable instance or null
     */
     ...
     *
     * @type member
     * @return {bomdemo.box.Resizable} resizable instance or null
     */
    ...
    __onSelect : function(e) {
      bomdemo.box.Manager.getInstance().setActiveBox(this);
    }    
  },
