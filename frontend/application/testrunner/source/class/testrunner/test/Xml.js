...
qx.Class.define("testrunner.test.Xml",
{
  ...
  members :
  {
    ...
    __testXHR : function()
    {
      ...
      var req = new qx.io.remote.Request(qx.util.AliasManager.getInstance().resolve("testrunner/data/qooxdoo-blog.xml"), qx.legacy.util.Http.METHOD_GET, qx.legacy.util.Mime.XML);
