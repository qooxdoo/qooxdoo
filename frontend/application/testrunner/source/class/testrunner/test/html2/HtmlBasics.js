...
qx.Class.define("testrunner.test.html2.HtmlBasics",
{
  ...
  members :
  {
    ...
    testElementAttributes : function()
    {
      ...
      //this.assertEquals(true, attrib.get(document.getElementById("test6"), "style"));
      //this.assertEquals(true, util.getCss(document.getElementById("test6")));
      ...
      this.info("test9");
      this.debug("Document: " + qx.html2.Document.getWidth() + "x" + qx.html2.Document.getHeight());
      this.debug("Viewport: " + qx.html2.Viewport.getWidth() + "x" + qx.html2.Viewport.getHeight());
    }
