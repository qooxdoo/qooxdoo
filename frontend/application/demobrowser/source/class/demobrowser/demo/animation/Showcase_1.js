...
qx.Class.define("demobrowser.demo.animation.Showcase_1",
{
  ...
  members :
  {
    main: function()
    {
      ...
      */
      var animShow = new qx.fx.effect.core.Fade(myElement).set({
        from : 0,
        to : 1,
        duration : 1
      });
      ...
      */
      var animHide = new qx.fx.effect.core.Fade(myElement).set({
        duration : 1,
        from : 1,
        to : 0
      });
      ...
      */
      var animFadeInWobble = new qx.fx.effect.core.Fade(myElement);
