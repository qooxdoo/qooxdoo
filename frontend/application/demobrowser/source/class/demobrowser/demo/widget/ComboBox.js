...
qx.Class.define("demobrowser.demo.widget.ComboBox",
{
  ...
  members :
  {
    ...
    _createDefaultExample : function()
    {
      ...
      label.setFont("bold");
      this.getRoot().add(label, {left: 20, top: 25});
      ...
      this.getRoot().add(comboBox, {left: 20, top: 40});
    },
    ...
    _createIconExample : function() 
    {
      ...
      label.setFont("bold");
      this.getRoot().add(label, {left: 140, top: 25});
      ...
      // add the combobox to the documents root
      this.getRoot().add(comboBox, {left: 140, top: 40});      
    },
    ...
    _createWideExample : function() 
    {
      ...
      label.setFont("bold");
      this.getRoot().add(label, {left: 20, top: 275});
      ...
      // add the combobox to the documents root
      this.getRoot().add(comboBox, {left: 20, top: 300}); 
    }
  }
});
