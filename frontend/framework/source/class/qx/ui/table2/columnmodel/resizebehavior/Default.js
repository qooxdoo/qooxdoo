 ...
 */
qx.Class.define("qx.ui.table2.columnmodel.resizebehavior.Default",
{
  extend : qx.ui.table2.columnmodel.resizebehavior.Abstract,
  ...
  */
  ...
  properties :
  {
    ...
    newResizeBehaviorColumnData :
    {
      ...
      init : function(obj)
      {
        return new qx.ui.table2.columnmodel.resizebehavior.ColumnData();
      }
    }
  },
      ...
      if (flexibleColumns.length > 0)
      {
        ...
        if (widthRemaining <= 0)
        {
          ...
          for (i=0; i<flexibleColumnsLength; i++)
          {
            ...
            computedFlexibleWidth =
              columnData._computedWidthFlexValue =
              (qx.ui.table2.columnmodel.resizebehavior.Default.MIN_WIDTH *
