...
qx.Clazz.define("qx.ui.treevirtual.SimpleTreeDataModel",
{
  ...
  */
  ...
  members :
  {
     ...
     *
     * @type member
     * @param columnIndex {Integer} The index of the column in which the tree should be displayed.
     * @return {void}
     */
     ...
     *
     * @type member
     * @return {Integer} The column in whcih the tree is to be displayed
     */
     ...
     * @param bOpened {Integer} <i>true</i> if the tree should be rendered in its opened state;
     *     <i>false</i> otherwise.
     ...
     * @param type {Integer} The type of node being added.  The type determines whether children may
     ...
     * @throws TODOC
     */
    _addNode : function(parentNodeId, label, bOpened, bHideOpenCloseButton, type, icon, iconSelected)
    {
      var parentNode;
     ...
     * @param parentNodeId {Integer} The node id of the parent of the node being added
     * @param label {String} The string to display as the label for this node
     * @param bOpened {Boolean} <i>True</i> if the branch should be rendered in its opened state;
     *     <i>false</i> otherwise.
     * @param bHideOpenCloseButton {Boolean} <i>True</i> if the open/close button should not be displayed;
     *     <i>false</i> if the open/close button should be displayed
     * @param icon {String} The relative (subject to alias expansion) or full path of the icon to
     *     display for this node when it is not a selected node.
     * @param iconSelected {String} The relative (subject to alias expansion) or full path of the icon to
     *     display for this node when it is a selected node.
     * @return {Integer} The node id of the newly-added branch.
     */
    addBranch : function(parentNodeId, label, bOpened, bHideOpenCloseButton, icon, iconSelected) {
      return this._addNode(parentNodeId, label, bOpened, bHideOpenCloseButton, qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH, icon, iconSelected);
    },
    ...
    addLeaf : function(parentNodeId, label, icon, iconSelected) {
      return this._addNode(parentNodeId, label, false, false, qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF, icon, iconSelected);
    },
     ...
     *
     * @type member
     * @param nodeId {Integer} The node id, previously returned by {@link #addLeaf} or {@link
     *     #addBranch}, of the node (and its children) to be pruned from the tree.
     * @param bSelfAlso {Boolean} If <i>true</i> then remove the node identified by <i>nodeId</i> as well
     ...
     *
     * @type member
     * @param nodeArr {Array | null} Pass either an Array of node objects, or null.
     *
     *
     ...
     *
     * @type member
     * @return {Array} Array of node objects.  See {@link qx.ui.treevirtual.SimpleTreeDataModel}
     ...
     *
     * @type member
     * @param nodeId {Integer} A node identifier, as previously returned by {@link #addBranch} or {@link
     *     addLeaf}.
     * @param columnIndex {Integer} The column number to which the provided data applies
     * @param data {var} The cell data for the specified column
     * @return {void}
     */
     ...
     */
    getColumnData : function(nodeId, columnIndex, data) {
     ...
     * @param nodeId {Integer} A node identifier, as previously returned by {@link #addBranch} or {@link
     *     addLeaf}.
     * @param attributes {Map} Each property name in the map may correspond to the property names of a
     ...
     *
     * @type member
     * @return {Array} The array containing mappings of nodes to rendered rows.
     */
