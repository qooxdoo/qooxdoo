 ...
 * class.
 */
qx.Class.define("qx.ui.table2.columnmodel.resizebehavior.Abstract",
{
  type : "abstract",
  ...
  */
  ...
  members :
  {
     ...
     * @type member
     * @abstract
     * @param tableColumnModel {qx.ui.table2.columnmodel.Resize} The table column model in use.  Of particular interest is the property
     ...
     *
     * @type member
     * @param tableColumnModel {qx.ui.table2.columnmodel.Resize}
    ...
    _getAvailableWidth : function(tableColumnModel)
    {
      ...
      var width = qx.legacy.html.Dimension.getInnerWidth(el) - 2;
