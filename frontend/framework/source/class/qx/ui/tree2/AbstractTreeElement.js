...
qx.Class.define("qx.ui.tree2.AbstractTreeElement",
{
  ...
  */
  ...
  construct : function(treeRowStructure)
  {
    ...
    console.log(treeRowStructure._label);
    if (treeRowStructure._label) {
    ...
    for (var i=0; i<treeRowStructure._fields.length; i++) {
      layout.add(treeRowStructure._fields[i], 0, i);
    }
  ...
  members :
  {
    ...
    */
    ...
    _applyLabel : function(value, old)
    {
      if (this._labelObject) {
        this._labelObject.setContent(value);
      }
    },
    ...
    */
    ...
    getParent : function()
    {
      if (
        ...
        typeof(this.getLayoutParent().getLayoutParent) == "function"
      ) {
        return this.getLayoutParent().getLayoutParent();
      }
      return null;
    },
    ...
    */
    ...
    syncWidget : function()
    {
      ...
      this._previousParentFolder = this.getParent();
      this._wasLastVisibleChild = false; //this.isLastVisibleChild();
      ...
      for (var i=vMinLevel; i<vMaxLevel; i++)
      {
        ...
        vCurrentObject = vCurrentObject.getParent();
      }
