...
qx.Class.define("qx.core.Log",
{
   ...
   statics :
   {
     ...
     dir : function(object)
     {
         ...
         for (var i = 0; i < pairs.length; ++i)
         {
             ...
             '<td class="propertyNameCell"><span class="propertyName">',
                 this.escapeHTML(name), '</span></td>', '<td><span class="propertyValue">');
    ...
    consoleShortcuts : { log    : "console.log", info : "console.info", debug : "console.debug", warn : "console.warn", error : "console.error", 
                         assert : "console.assert",
                         dir    : "console.dir", dirxml : "console.dirxml",
                         group  : "console.group", groupEnd : "console.groupEnd",
                         time   : "console.time", timeEnd : "console.timeEnd",
                         clear  : "console.clear", close : "console.close" },
    ...
    createFrame : function()
    {
        ...
        window.onLogReady = function(doc){ qx.core.Log.onLogReady.call(qx.core.Log, doc);  };   
        ...
        consoleFrame.style.position = "absolute"; //"fixed";
    ...
    onLogReady : function(doc)
    {
       ...
       toolbar.onmousedown = function(e){ qx.core.Log.onSplitterMouseDown.call(qx.core.Log, e) };
     ...
     * @return {String ? null} Returns the converted string or null
     */
    ...
    {
        html.push('<span class="objectBox-string">&quot;', this.escapeHTML(this.objectToString(object)),
            '&quot;</span>');
    },
    ...
    */
    appendSelector : function(object, html)
    {
        ...
        if (object.id)
            html.push('<span class="selectorId">#', this.escapeHTML(object.id), '</span>');
        if (object.className)
            html.push('<span class="selectorClass">.', this.escapeHTML(object.className), '</span>');
    ...
    */
    appendNode : function(node, html)
    {
        if (node.nodeType == 1)
        {
            ...
            for (var i = 0; i < node.attributes.length; ++i)
            {
                ...
                html.push('&nbsp;<span class="nodeName">', attr.nodeName.toLowerCase(),
                    '</span>=&quot;<span class="nodeValue">', this.escapeHTML(attr.nodeValue),
                    '</span>&quot;')
            }
        ...
        {
            html.push('<div class="nodeText">', this.escapeHTML(node.nodeValue),
                '</div>');
        }
    },
    ...
    {
        if (qx.core.Client.isWebkit() || qx.core.Client.isOpera())
            return;
    ...
    onSplitterMouseMove : function(event)
    {
        ...
        var minimumHeight = qx.core.Log.consoleBody.ownerDocument.getElementById("toolbar").offsetHeight + 
                            qx.core.Log.commandLine.offsetHeight;
    ...
    {
        if (event.keyCode == 13)
            qx.core.Log.evalCommandLine();
        else if (event.keyCode == 27)
            qx.core.Log.commandLine.value = "";
    }
  },
