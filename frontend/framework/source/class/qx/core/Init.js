  ...
  */
  ...
  members :
  {
    ...
    _onload : function(e)
    {
      ...
      this.debug("engine: " + qx.html2.client.Engine.NAME + "-" + qx.html2.client.Engine.VERSION);
      this.debug("system: " + qx.html2.client.Platform.NAME + " | " + qx.html2.client.System.NAME);
