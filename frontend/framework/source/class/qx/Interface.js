...
qx.Clazz.define("qx.Interface", 
{
  statics :
  {
     ...
     * @param definition.extends {List,null} list of interfaces to extend from
     * @param definition.members {Map,null} hash of constant properties and/or abstract methods
     */
          ...
          if (vSuper instanceof Array)
          {
            ...
            for (i=0; i<vTotal; i++)
            {
              if (typeof vSuper[i] === "undefined" || !vSuper[i].isInterface) {
                throw new Error("Could not extend interface " + fullname
