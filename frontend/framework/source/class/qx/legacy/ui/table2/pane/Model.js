 ...
 * {@link qx.legacy.ui.table2.columnmodel.Basic} and manages the visual order of the columns shown in
 * a {@link TablePane}.
 */
qx.Class.define("qx.legacy.ui.table2.pane.Model",
{
  ...
  */
  ...
  /**
   *
   * @param tableColumnModel {qx.legacy.ui.table2.columnmodel.Basic} The TableColumnModel of which this
   *    model is the proxy.
   */
  ...
  */
  ...
  members :
  {
    ...
    _applyFirstColumnX : function(value, old)
    {
      ...
      this.fireEvent(qx.legacy.ui.table2.pane.Model.EVENT_TYPE_MODEL_CHANGED);
    },
