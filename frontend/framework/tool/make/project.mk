...
#
ifndef APPLICATION_APPLICATION
  APPLICATION_APPLICATION = $(APPLICATION_NAMESPACE).Application
endif
...
#
ifndef APPLICATION_DEFINE_DEFAULT_TARGETS
  APPLICATION_DEFINE_DEFAULT_TARGETS = true
endif
...
ifeq ($(APPLICATION_COMPLETE_SOURCE),false)
  COMPUTED_SOURCE_INCLUDE = --include $(APPLICATION_APPLICATION) \
...
ifneq ($(APPLICATION_COMPLETE_BUILD),true)
  COMPUTED_BUILD_INCLUDE = --include $(APPLICATION_APPLICATION) \
    $(COMPUTED_FRAMEWORK_LOCALE_INCLUDE) \
    $(COMPUTED_FRAMEWORK_TRANSLATION_INCLUDE) \
    $(COMPUTED_APPLICATION_TRANSLATION_INCLUDE) 
endif
...
ifeq ($(APPLICATION_COMPLETE_API),false)
  COMPUTED_API_INCLUDE = --include $(APPLICATION_APPLICATION)
endif
