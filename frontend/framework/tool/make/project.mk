...
ifndef PROJECT_TRANSLATION_FOLDERNAME
  PROJECT_TRANSLATION_FOLDERNAME = translation
endif
...
# Translation path
#
ifndef PROJECT_TRANSLATION_PATH
  PROJECT_TRANSLATION_PATH = $(PROJECT_SOURCE_PATH)/$(PROJECT_TRANSLATION_FOLDERNAME)
endif

#
# Namespace of translation classes
#
ifndef PROJECT_TRANSLATION_CLASS_NAMESPACE
  PROJECT_TRANSLATION_CLASS_NAMESPACE = $(PROJECT_NAMESPACE).$(PROJECT_TRANSLATION_FOLDERNAME)
endif

#
# Directory of translation classes
#
ifndef PROJECT_TRANSLATION_CLASS_PATH
  PROJECT_TRANSLATION_CLASS_PATH = $(PROJECT_SOURCE_PATH)/$(PROJECT_CLASS_FOLDERNAME)/$(PROJECT_NAMESPACE)/$(PROJECT_TRANSLATION_FOLDERNAME)
endif
...
FRAMEWORK_LOCALE_STATIC_PATH = $(FRAMEWORK_PATH)/locale
...
COMPUTED_CLASS_URI = --class-uri $(FRAMEWORK_SOURCE_URI)/class \
  --class-uri $(PROJECT_PAGE_TO_TOPLEVEL)/$(PROJECT_CLASS_FOLDERNAME) \
  $(PROJECT_ADDITIONAL_CLASS_URI)
...
COMPUTED_FRAMEWORK_LOCALE_INCLUDE := $(PROJECT_LOCALES:%= --include qx.locale.data.% )  
COMPUTED_FRAMEWORK_TRANSLATION_INCLUDE := $(PROJECT_LOCALES:%= --include $(FRAMEWORK_TRANSLATION_CLASS_NAMESPACE).% )  
COMPUTED_PROJECT_TRANSLATION_INCLUDE := $(PROJECT_LOCALES:%= --include $(PROJECT_TRANSLATION_CLASS_NAMESPACE).% )  
...
ifeq ($(PROJECT_COMPLETE_SOURCE),false)
  COMPUTED_SOURCE_INCLUDE = --include $(PROJECT_APPLICATION) \
    ...
    $(COMPUTED_PROJECT_TRANSLATION_INCLUDE) 
endif
