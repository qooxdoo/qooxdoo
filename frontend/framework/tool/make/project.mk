...
# Locale namespace
#
ifndef PROJECT_TRANSLATION_NAMESPACE
  PROJECT_TRANSLATION_NAMESPACE = $(PROJECT_NAMESPACE).$(PROJECT_TRANSLATION_FOLDERNAME)
endif
...
ifndef PROJECT_TRANSLATION_PATH
  PROJECT_TRANSLATION_PATH = $(PROJECT_SOURCE_PATH)/$(PROJECT_CLASS_FOLDERNAME)/$(PROJECT_NAMESPACE)/$(PROJECT_TRANSLATION_FOLDERNAME)
endif
...
FRAMEWORK_LOCALE_CLASS_PATH = $(FRAMEWORK_SOURCE_PATH)/class/qx/locale/data
