...
COMPUTED_SOURCE_SETTING += --use-setting qx.initApplication:$(APPLICATION_NAMESPACE).$(APPLICATION_CLASSNAME)
COMPUTED_BUILD_SETTING += --use-setting qx.initApplication:$(APPLICATION_NAMESPACE).$(APPLICATION_CLASSNAME)
