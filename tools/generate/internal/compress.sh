...
python tools/generate/internal/compile.py --sourcepath source/script --buildpath build/script --cachepath "tools/generate/internal/cache/script" --docpath build/docs --prefix docs --job compress
