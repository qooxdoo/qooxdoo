...
qx.Class.define("qx.test.data.async.Resolve", {
  ...
  members: {
    testResolveDepth1() {
      ...
      this.assertEquals(12, qx.data.SingleValueBindingAsync.resolvePropertyChain(model, "a"));
    ...
    testResolveDepth2() {
      ...
      this.assertEquals(12, qx.data.SingleValueBindingAsync.resolvePropertyChain(model, "a.b"));
    ...
    testResolveDepthHuge() {
      ...
      this.assertEquals(12, qx.data.SingleValueBindingAsync.resolvePropertyChain(model, "a.b.c.d.e.f"));
    ...
    testResolveArrayIndex() {
      ...
      this.assertEquals(23, qx.data.SingleValueBindingAsync.resolvePropertyChain(arr, "[0]"));
    },

    testResolveWithArray() {
      var model = qx.data.marshal.Json.createModel({ a: { b: [{ c: 12 }] } });
      this.assertEquals(12, qx.data.SingleValueBindingAsync.resolvePropertyChain(model, "a.b[0].c"));
    ...
    testResolveNestedArray() {
      ...
      this.assertEquals(23, qx.data.SingleValueBindingAsync.resolvePropertyChain(model, "a[0][0]"));
