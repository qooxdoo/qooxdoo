...
qx.Class.define("qx.test.bom.element.Background", {
  ...
  members: {
    ...
    testGetStyles() {
      var styles = qx.bom.element.Background.getStyles(
        "foo/bar/baz.gif",
        "no-repeat",
        null,
        null
      ...
      this.assertKeyInMap(
        "backgroundPosition",
        styles,
        "Key 'backgroundPosition' is not present!"
      );
    ...
    testGetStylesBase64() {
      ...
      this.assertEquals(
        "url('" + this.__backgroundUrlBase64 + "')",
        styles["backgroundImage"],
        "Wrong value for base64 encoded background image!"
      );
    },

    testCompile() {
      var cssString = qx.bom.element.Background.compile(
        "foo/bar/baz",
        "no-repeat",
        null,
        null
      ...
      var expected =
        "background-image:url('foo/bar/baz');background-position:0 0;" +
        "background-repeat:no-repeat;";
      this.assertEquals(
        expected,
        cssString,
        "Compiled CSS string is not valid!"
      );
    },

    testCompileBase64() {
      var cssStringBase64 = qx.bom.element.Background.compile(
        this.__backgroundUrlBase64,
        "no-repeat",
        null,
        null
      ...
      this.assertEquals(
        expected,
        cssStringBase64,
        "Compiled CSS string for base64 image is not valid!"
      );
    }
  }
});
