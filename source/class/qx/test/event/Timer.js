      ...
      this.wait(
        ...
        function () {
          ...
          this.assertIdentical(
            0,
            runCount,
            "New timer did fire interval event without explicitly being started by calling start() or by setting enabled property to true"
          );
        }.bind(this)
      );
    },
      ...
      this.wait(
        ...
        function () {
          this.assertIdentical(
            1,
            runCount,
            "Static method once() is expected to start automatically and to run exactly once"
          );
        }.bind(this)
      );
    }
