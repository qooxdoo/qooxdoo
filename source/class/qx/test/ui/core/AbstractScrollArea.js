...
qx.Class.define("qx.test.ui.core.AbstractScrollArea", {
  ...
  members: {
    ...
    setUp() {
      ...
      this.__widget =
        new qx.test.ui.core.AbstractScrollArea.fixture.CustomWidget();
    ...
    "test smaller widget than container"() {
      var inner = new qx.ui.core.Widget();
    ...
    "test bigger widget than container"() {
      var inner = new qx.ui.core.Widget();
    ...
    "test bigger preferred widget than container"() {
      var inner = new qx.ui.core.Widget();
    ...
    "test bigger widget than smaller preferred container"() {
      var inner = new qx.ui.core.Widget();
      inner.set({ minWidth: 120, minHeight: 120 });
      this.__widget.setSingleChild(inner);
