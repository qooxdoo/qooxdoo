...
qx.Class.define("qx.test.mobile.basic.Atom", {
  ...
  members: {
    testLabel() {
      ...
      this.assertEquals(
        atom.getLabel(),
        atom.getLabelWidget().getContainerElement().innerHTML
      );
    ...
    testIcon() {
      ...
      this.assertTrue(
        atom
          .getIconWidget()
          .getContainerElement()
          .src.indexOf("qx/icon/Tango/48/places/user-home.png") != -1
      );

      var image2URL = qx.util.ResourceManager.getInstance().toUri(
      ...
      this.assertTrue(
        atom
          .getIconWidget()
          .getContainerElement()
          .src.indexOf("qx/icon/Tango/32/places/folder-open.png") != -1
      );
    ...
    testIconPosition() {
      ...
      this.assertTrue(
        qx.bom.element.Location.getTop(iconElement) <=
      ...
      this.assertTrue(
        iconLeft >= labelLeft,
        "setIconPosition(right): iconElement.left is lower than labelElement.left"
      );
