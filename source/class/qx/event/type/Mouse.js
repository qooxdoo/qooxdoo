  ...
  members: {
    ...
    _cloneNativeEvent(nativeEvent, clone) {
      ...
      clone.pageX = nativeEvent.pageX
        ? Math.round(nativeEvent.pageX)
        : undefined;
      clone.pageY = nativeEvent.pageY
        ? Math.round(nativeEvent.pageY)
        : undefined;
        ...
        default:
          if (
            ...
            if (this._native.button === -1) {
              return (
                this.__buttonsDom3EventModel[this._native.buttons] || "none"
              );
            }
            return this.__buttonsDom2EventModel[this._native.button] || "none";
          } else {
            return (
              this.__buttonsMshtmlEventModel[this._native.button] || "none"
            );
          }
      }
    },
