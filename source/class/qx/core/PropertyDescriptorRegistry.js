...
qx.Class.define("qx.core.PropertyDescriptorRegistry", {
  extend: Object,
  ...
  statics: {
     ...
     *   object.
     */
    getClassProperty(className, propertyName) {
  ...
  members: {
     ...
     */
    register(className, propertyName, propertyDescriptor) {
      let globalRegistry = qx.core.PropertyDescriptorRegistry.__globalRegistry;
    ...
    get(context, propertyName) {
      ...
      for (let key in propertyDescriptor) {
        ...
        // Bind this function
        boundPropertyDescriptor[key] = propertyDescriptor[key].bind(context);
      }
