...
qx.Mixin.define("qx.ui.core.MPlacement", {
  ...
  members: {
    ...
    placeToWidget(target, liveupdate) {
      ...
      const size = this.__getPlacementSize();

      if (coords != null) {
        if (this._boundsAreEqual(coords, this.__lastKnownCoords) &&
          this._boundsAreEqual(size, this.__lastKnownSize)) {
          return true;
        }
