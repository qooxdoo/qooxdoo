...
qx.Class.define("qx.ui.mobile.basic.Atom", {
  ...
  */
  ...
  members: {
     ...
     */
    __createLayout(verticalLayout, hasNoLabel) {
    ...
    __createChildren(label, icon) {
      ...
      var verticalLayout =
        ["top", "bottom"].indexOf(this.getIconPosition()) != -1;
