...
qx.Class.define("qx.ui.mobile.list.provider.Provider", {
  ...
  members: {
     ...
     * @param group {Integer} The group index.
     */
    _configureGroupItem(data, group) {
      var configureGroupItem = qx.util.Delegate.getMethod(
        this.getDelegate(),
        "configureGroupItem"
      );
    ...
    _createGroupRenderer() {
      var createGroupRenderer = qx.util.Delegate.getMethod(
        this.getDelegate(),
        "createGroupRenderer"
      );
     ...
     */
    _createItemRenderer() {
      var createItemRenderer = qx.util.Delegate.getMethod(
        this.getDelegate(),
        "createItemRenderer"
      );
