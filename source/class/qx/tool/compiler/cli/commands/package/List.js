 ...
 */
qx.Class.define("qx.tool.compiler.cli.commands.package.List", {
  ...
  statics: {
    ...
    async createCliCommand(clazz = this) {
      ...
      cmd.addFlag(
        new qx.tool.cli.Flag("match").set({
          shortCode: "m",
  ...
  members: {
    ...
    async process(argv = null) {
      ...
      try {
        ...
        throw new Error("Cannot determine a qooxdoo version to show packages only for this version, because you are not in a project directory.");
      }
