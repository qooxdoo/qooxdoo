 ...
 * @ignore(setImmediate)
 */
qx.Class.define("qx.tool.compiler.cli.Watch", {
  ...
  members: {
    ...
    __make() {
      ...
      function make() {
        Console.print("qx.tool.compiler.cli.watch.makingApplications");
        ...
        return t.__maker
          ...
          .then(() => {
            if (t.__stopping) {
              Console.print("qx.tool.compiler.cli.watch.makeStopping");
              return null;
            }
            ...
            if (t.__outOfDate) {
              return new qx.Promise(resolve => {
                setImmediate(function () {
                  Console.print("qx.tool.compiler.cli.watch.restartingMake");
            ...
            return Promise.all(promises).then(() => {
              ...
              Console.print(
                "qx.tool.compiler.cli.watch.compiledClasses",
          ...
          .catch(err => {
            Console.print("qx.tool.compiler.cli.watch.compileFailed", err);
            t.__making = null;
            t.fireEvent("made");
          });
      }
  ...
  defer() {
    qx.tool.compiler.Console.addMessageIds({
      "qx.tool.compiler.cli.watch.makingApplications": ">>> Making the applications...",
      "qx.tool.compiler.cli.watch.restartingMake":
        ">>> Code changed during make, restarting...",
      "qx.tool.compiler.cli.watch.makeStopping":
        ">>> Not restarting make because make is stopping...",
      "qx.tool.compiler.cli.watch.compiledClasses": ">>> Compiled %1 classes in %2"
    });

    qx.tool.compiler.Console.addMessageIds(
      {
        "qx.tool.compiler.cli.watch.compileFailed": ">>> Fatal error during compile: %1",
        "qx.tool.compiler.cli.watch.enospcError":
