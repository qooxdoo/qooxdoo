  function QxColorPresetPopup(vTemplateColors, vHistoryColors, vColorSelector)
  {
    ...
    var o = this._auto = new QxAtom("Automatisch", "icons/16/iconthemes.png");
    ...
    var o = this._previewOld = new QxAtom("Aktuelle Farbe");
    ...
    var o = this._previewNew = new QxAtom("Neue Farbe");
    ...
    var o = this._vStartComplex = new QxAtom("Alle Farben...", "icons/16/kcoloredit.png");
