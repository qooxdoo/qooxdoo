...
If you are using your normal workspace, make at least sure to run a
*distclean*.
...
All test objects (applications, libraries, SDK) are usually made
...
After that, developers will receive the new branch with their next pull
