...
* **code** : code options
  ...
  * **optimize** : list of dimensions for optimization, max. ["basecalls", "comments", "privates", "strings", "variables", "variants", "whitespace"] (default: *[]*) :ref:`special section <pages/tool/generator_config_articles#optimize_key>`
