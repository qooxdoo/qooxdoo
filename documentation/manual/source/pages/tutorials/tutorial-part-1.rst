...
Thats it for the first part. If you want to have the `code from the tutorial <https://github.com/qooxdoo/qooxdoo/tree/%{release_tag}/qooxdoo/component/tutorials/twitter/step1>`_, take a look at the project on github and just fork the project.
