...
The first questions is easy to answer, we can change CSS properties. The answer to the second questions gives the following code.
...
Take a look at `demo <http://demo.qooxdoo.org/%{version}/demobrowser/demo/bom/Animation.html>`_ showing a 3D rotation which you can try yourself. It shows the best results if you use a webkit based browser.