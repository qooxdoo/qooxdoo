...
/**
 * Test number formatting.  Null values should display as zero when the
 * Number cell renderer is in use; as empty if the default cell renderer
 * is in use.
 */
qx.Class.define("demobrowser.demo.legacy.Table_6",
{
  ...
  members :
  {
    main : function()
    {
      ...
      with (table) {
        ...
        var renderer = new qx.legacy.ui.table.cellrenderer.Number();
