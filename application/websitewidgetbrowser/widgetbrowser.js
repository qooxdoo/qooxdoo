...
q.ready(function() {
  ...
  var title = version ? "Widget Browser <span>qx.Website " + version + "</span>" : "Widget Browser <span>qx.Website</span>";
  q("h1").setHtml(title);

  var docTitle = version ? "qx.Website " + version + " Widget Browser" : "qx.Website Widget Browser";
